...
},{"./url":"../../../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../../../node_modules/socket.io-parser/index.js","./manager":"../../../node_modules/socket.io-client/lib/manager.js","debug":"../../../node_modules/debug/src/browser.js","./socket":"../../../node_modules/socket.io-client/lib/socket.js"}],"message-bus/ws-client.ts":[function(require,module,exports) {
"use strict";
...
class WSClient {
  constructor() {
    ...
    this.socket = socket_io_client_1.connect({
      autoConnect: false,
  ...
  connect(params, cb) {
    ...
    if (typeof socket_io_client_1.connect !== 'function') {
      return;
    }
...
},{"socket.io-client":"../../../node_modules/socket.io-client/lib/index.js"}],"message-bus/worker.ts":[function(require,module,exports) {
"use strict";
...
worker.addEventListener('connect', e => {
  ...
  port.addEventListener('message', event => {
    ...
    if (input.command === 'process-message') {
      ...
      const params = {
        broadcast: (_a = inputMessage.broadcast) !== null && _a !== void 0 ? _a : false,
        self: (_b = inputMessage.self) !== null && _b !== void 0 ? _b : false
      };
      hub.notify({
        type: 'message',
        payload: message,
...
},{"./ws-client":"message-bus/ws-client.ts"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","message-bus/worker.ts"], null)
//# sourceMappingURL=/worker.b31cd19b.js.map